<header>
  <nav class="bg-white">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between lg:justify-end mx-auto p-4 my-2 lg:my-4">
      <button class="flex items-center p-2 border border-gray-200 rounded-md lg:hidden"
      type="button" data-drawer-target="drawer-sidebar" data-drawer-show="drawer-sidebar" aria-controls="drawer-navigation">
          <i class="w-5 h-5 text-gray-600" data-feather="menu"></i>
      </button>
