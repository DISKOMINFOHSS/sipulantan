    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
      ...
      <div class="px-6 py-6 lg:px-8">
        <h3 class="mb-5 text-xl font-medium text-gray-900">Tambah Kategori Baru</h3>
          <form class="space-y-6 my-6" action="" method="post" enctype="multipart/form-data">
            @method('')
            @csrf
            <div>
            ...
            <div>
              ...
              <input class="block mb-3 w-full text-sm text-gray-500 border border-gray-300 rounded-lg cursor-pointer focus:outline-none" aria-describedby="file_input_help" id="photo" name="photo" type="file">
            </div>
